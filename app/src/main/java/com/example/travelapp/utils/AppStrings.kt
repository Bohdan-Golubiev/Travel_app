...
val EnglishStrings = AppStrings(
    ...
    toHotelSearch = "To: ",
    noInternetError = "No internet access",
    hotelSearchError = "Сheck that location is spelled correctly",
    error = "Error: ",
    clarify = "Or refine your search by adding name of country",
    totalCost = "Total: ",
    update = "Update",
...
val UkrainianStrings = AppStrings(
    ...
    fromHotelSearch = "З: ",
    toHotelSearch = "До: ",
    noInternetError = "Немає доступу до Інтернету",
    hotelSearchError = "Перевірте правильність написання локації",
    error = "Помилка: ",
    clarify = "Або уточніть запит, додавши назву країни",
    totalCost = "Загалом: ",
    update = "Оновити",
